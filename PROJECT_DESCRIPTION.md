...
- Standalone HHS4185 source packages: `sources/HHS4185/` contains separate course-material, workshop, tutorial, and supplemental-source packages; Workshop 2 — Introduction to Rehabilitation Equipment (2) is registered as `HHS4185-WS2-EQUIPMENT-2026`.
- Processed course source packages also include nine deduplicated HHS3190M physiology/anatomy course packages under `sources/HHS3190M/` (eight lecture-deck packages plus one official Semester 1 Scheme of Module Activity package) and the eight unique HHS4867 Functional Movement Science presentation packages under `sources/HHS4867/`; each source remains separate from the other course and supplemental packages.
