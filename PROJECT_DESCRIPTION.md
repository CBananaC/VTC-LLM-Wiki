...
- Processed course source packages also include eight deduplicated HHS3190M physiology/anatomy lecture packages under `sources/HHS3190M/` and the eight unique HHS4867 Functional Movement Science presentation packages under `sources/HHS4867/`; each source remains separate from the other course and supplemental packages.
