...
- Source: `HHS4867-L01-AMBULATION-TRANSFER` — `Lecture 1 - Ambulation & Transfer`.
...
- Tables are separate records in `02 Text and Tables/hhs4867_l01_ambulation_transfer_tables_generated.json`; non-table visuals are metadata-only unless explicitly marked otherwise.
...
Query helper (relative to this file): `../../../../tools/query_hhs4867_l01_ambulation_transfer.py`
