...
- Source: `HHS4867-L03-RANGE-OF-MOTION` — `Lecture 3 - Measurement of Range of Motion (ROM)`.
...
- Tables are separate records in `02 Text and Tables/hhs4867_l03_range_of_motion_tables_generated.json`; non-table visuals are metadata-only unless explicitly marked otherwise.
...
Query helper (relative to this file): `../../../../tools/query_hhs4867_l03_range_of_motion.py`
