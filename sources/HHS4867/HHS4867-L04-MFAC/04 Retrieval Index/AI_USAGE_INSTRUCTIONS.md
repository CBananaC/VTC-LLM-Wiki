...
- Source: `HHS4867-L04-MFAC` — `Lecture 4 - Modified Functional Ambulation Categories`.
...
- Tables are separate records in `02 Text and Tables/hhs4867_l04_mfac_tables_generated.json`; non-table visuals are metadata-only unless explicitly marked otherwise.
...
Query helper (relative to this file): `../../../../tools/query_hhs4867_l04_mfac.py`
