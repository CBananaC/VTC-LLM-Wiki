...
- Source: `HHS4867-L05-MOBILITY-WALKING-AIDS` — `Lecture 5 - Mobility and Walking Aids`.
...
- Tables are separate records in `02 Text and Tables/hhs4867_l05_mobility_walking_aids_tables_generated.json`; non-table visuals are metadata-only unless explicitly marked otherwise.
...
Query helper (relative to this file): `../../../../tools/query_hhs4867_l05_mobility_walking_aids.py`
