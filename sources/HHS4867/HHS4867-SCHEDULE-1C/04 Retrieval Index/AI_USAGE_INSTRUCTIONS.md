...
- Source: `HHS4867-SCHEDULE-1C` — `Functional Movement Science - Class 1C Lecture Schedule`.
...
- Tables are separate records in `02 Text and Tables/hhs4867_schedule_1c_tables_generated.json`; non-table visuals are metadata-only unless explicitly marked otherwise.
...
Query helper (relative to this file): `../../../../tools/query_hhs4867_schedule_1c.py`
