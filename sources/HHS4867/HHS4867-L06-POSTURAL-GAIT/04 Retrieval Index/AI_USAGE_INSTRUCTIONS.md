...
- Source: `HHS4867-L06-POSTURAL-GAIT` — `Lecture 6 - Postural and Gait Assessment`.
...
- Tables are separate records in `02 Text and Tables/hhs4867_l06_postural_gait_tables_generated.json`; non-table visuals are metadata-only unless explicitly marked otherwise.
...
Query helper (relative to this file): `../../../../tools/query_hhs4867_l06_postural_gait.py`
