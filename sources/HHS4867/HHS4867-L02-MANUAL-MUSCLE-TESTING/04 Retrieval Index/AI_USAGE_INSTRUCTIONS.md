...
- Source: `HHS4867-L02-MANUAL-MUSCLE-TESTING` — `Lecture 2 - Manual Muscle Testing (MMT)`.
...
- Tables are separate records in `02 Text and Tables/hhs4867_l02_manual_muscle_testing_tables_generated.json`; non-table visuals are metadata-only unless explicitly marked otherwise.
...
Query helper (relative to this file): `../../../../tools/query_hhs4867_l02_manual_muscle_testing.py`
