...
- `03 Analysis/stroke_rehab_hierarchical_structure_generated.json` — navigable Part/Chapter/Major-section/Subsection node graph with corrected same-page heading boundaries and paragraph/visual ownership.
